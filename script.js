...
function changeList2(num) {
    ...
    for (let index = 0; index < wrapper11.children.item(1).children.length; index++) {
        wrapper11.children.item(1).children.item(index).classList.remove('border-[#efcb19]');
        wrapper11.children.item(1).children.item(index).classList.remove('text-[#efcb19]');
    }
